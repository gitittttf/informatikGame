...
public class TutorialBoxRenderer {
    ...
    private static final int TYPEWRITER_SPEED = 4;

    /**
     * Renders a tutorial box with typewriter effect at the default bottom
     * position.
     *
    ...
    /**
     * Calculates the default Y position for the tutorial box (bottom of
     * screen).
     */
