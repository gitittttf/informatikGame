...
public class GameManager implements FightManager.CombatEventListener {
    ...
    public String getRoomStory() {
        ...
        return switch (roomName) {
            case "TUTORIAL_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.TUTORIAL_ROOM);
            case "INTRO_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.INTRO_ROOM);
            case "FLOOR_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.FLOOR_ROOM);
            case "PANTRY_1" ->
                StoryDatabank.getStory(StoryDatabank.PANTRY_1);
            case "LIBRARY_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.LIBRARY_ROOM);
            case "DINING_HALL" ->
                StoryDatabank.getStory(StoryDatabank.DINING_HALL);
            case "LABORATORY" ->
                StoryDatabank.getStory(StoryDatabank.LABORATORY);
            case "CORRIDOR" ->
                StoryDatabank.getStory(StoryDatabank.CORRIDOR);
            case "FINAL_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.FINAL_ROOM);
            default ->
    ...
    public String getExitStory() {
        ...
        return switch (roomName) {
            case "TUTORIAL_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.TUTORIAL_ROOM_END);
            case "INTRO_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.INTRO_ROOM_END);
            case "FLOOR_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.FLOOR_ROOM_END);
            case "PANTRY_1" ->
                StoryDatabank.getStory(StoryDatabank.PANTRY_1_END);
            case "LIBRARY_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.LIBRARY_ROOM_END);
            case "DINING_HALL" ->
                StoryDatabank.getStory(StoryDatabank.DINING_HALL_END);
            case "LABORATORY" ->
                StoryDatabank.getStory(StoryDatabank.LABORATORY_END);
            case "CORRIDOR" ->
                StoryDatabank.getStory(StoryDatabank.CORRIDOR_END);
            case "FINAL_ROOM" ->
                StoryDatabank.getStory(StoryDatabank.FINAL_ROOM_END);
            default ->
                "";
        };
    }
